      ...
      {[...new Array(2)].fill(0).map((_, idx) => (
        <>
          {props.testimonials.map(({ imageSrc, name, text, username }) => (
            <div className="p-10 bg-textBlack rounded-3xl w-full max-w-xs" key={username}>
              ...
              <div className="flex items-center gap-2 mt-5">
                ...
                <div className="flex flex-col">
                  <div className="text-neutral-300 font-medium tracking-tight leading-5">
                    {name}
                  </div>
                  <div className="leading-5 tracking-tight text-neutral-400">{username}</div>
                </div>
              </div>
            </div>
          ))}
  ...
  return (
    <section className="bg-black py-[72px]">
      <div className="container">
        ...
        Gamers all over Jhansi can't get enough of the time they spend here!
        </p>
