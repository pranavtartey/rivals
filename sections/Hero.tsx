...
const Hero: FC = () => {
  ...
  const controllerImageTransition = useTransform(
    scrollYProgress,
    [0.3, 0.5],
    [0, 10]
  );
        ...
        >
          <div className="h-full flex items-center justify-center">
            <div className="">
              ...
              <div className="mt-5 flex items-center justify-center [perspective:800px] [transform-style:preserve-3d]">
                <motion.div
              ...
              <div className="w-fit mx-auto relative">
                ...
                >
                  Your go-to spot for solo or group gaming. Enjoy the latest
                  titles with stunning graphics on PS5, VR, PC, or the Logitech
                  Driving Simulator—and refuel at our cafe for endless fun.
                </motion.p>
              </div>
